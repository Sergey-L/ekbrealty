...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Realty.area'
        db.alter_column('website_realty', 'area_id', self.gf('smart_selects.db_fields.GroupedForeignKey')(to=orm['website.Area']))

        # Adding M2M table for field area on 'Region'
        db.create_table('website_region_area', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('region', models.ForeignKey(orm['website.region'], null=False)),
            ('area', models.ForeignKey(orm['website.area'], null=False))
        ))
        db.create_unique('website_region_area', ['region_id', 'area_id'])

        # Deleting field 'Area.region'
        db.delete_column('website_area', 'region_id')


    def backwards(self, orm):
        
        # Changing field 'Realty.area'
        db.alter_column('website_realty', 'area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Area']))

        # Removing M2M table for field area on 'Region'
        db.delete_table('website_region_area')

        # Adding field 'Area.region'
        db.add_column('website_area', 'region', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['website.Region']), keep_default=False)
    ...
    models = {
        ...
        'website.realty': {
            ...
            'area': ('smart_selects.db_fields.GroupedForeignKey', [], {'to': "orm['website.Area']"}),
            'content': ('tinymce.models.HTMLField', [], {}),
        ...
        'website.region': {
            ...
            'area': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['website.Area']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'website.settings': {

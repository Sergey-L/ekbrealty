...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Realty.phone'
        db.add_column('website_realty', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Realty.email'
        db.add_column('website_realty', 'email', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Realty.phone'
        db.delete_column('website_realty', 'phone')

        # Deleting field 'Realty.email'
        db.delete_column('website_realty', 'email')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DealType.ind_show'
        db.delete_column('website_dealtype', 'ind_show')

        # Adding field 'RealtyType.ind_show'
        db.add_column('website_realtytype', 'ind_show', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DealType.ind_show'
        db.add_column('website_dealtype', 'ind_show', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'RealtyType.ind_show'
        db.delete_column('website_realtytype', 'ind_show')

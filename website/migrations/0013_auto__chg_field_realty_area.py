...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('website_realty', 'area_id', self.gf('smart_selects.db_fields.GroupedForeignKey')(to=orm['website.Area'], group_field='region'))
    ...
    models = {
        ...
        'website.realty': {
            ...
            'area': ('smart_selects.db_fields.GroupedForeignKey', [], {'to': "orm['website.Area']", 'group_field': "'region'"}),
            'content': ('tinymce.models.HTMLField', [], {}),
